                        ...
                        <form class="space-y-4" action="{{ route('post-kegiatan') }}" method="POST">
                            ...
                            <div>
                                <label for="tanggalMulai"
                                    ...
                                    dimulai </label>
                                <input id="tanggalMulai" type="date" name="tanggalMulai" autocomplete="off"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            ...
                            <div>
                                <label for="tanggalBerakhir"
                                    class="block mb-2 text-sm font-medium text-gray-900">Tanggal
                                    berakhir </label>
                                <input id="tanggalBerakhir" type="date" name="tanggalBerakhir" autocomplete="off"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    placeholder="Masukkan Tanggal kegiatan" required />
                            </div>
            ...
            <tbody>
                ...
                @foreach ($kegiatan as $dataKegiatan)
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4">{{ $dataKegiatan->tanggal_mulai }}</td>
                        <td class="px-6 py-4">{{ $dataKegiatan->tanggal_berakhir }}</td>
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div
                                            ...
                                            <h3
                                                class="text-xl font-semibold text-center w-full text-gray-900 ">
                                                Edit Kegiatan
                                            </h3>
                                            <button type="button"
                                            ...
                                            <form class="space-y-4" action="{{ route('edit-kegiatan',$dataKegiatan->id) }}" method="POST">
                                                ...
                                                <div>
                                                    <label for="tanggal"
                                                        class="block mb-2 text-sm font-medium text-gray-900">Tanggal
                                                        mulai : </label>
                                                    <input id="tanggal" type="date" name="tanggalMulai"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                        value="{{ $dataKegiatan->tanggal_mulai }}" required />
                                                </div>
                                                <div>
                                                    <label for="tanggal"
                                                        class="block mb-2 text-sm font-medium text-gray-900">Tanggal
                                                        berakhir : </label>
                                                    <input id="tanggal" type="date" name="tanggalBerakhir"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                        value="{{ $dataKegiatan->tanggal_berakhir }}" required />
                                                </div>
                                                <div>
                                                    <label for="jmlLab"
