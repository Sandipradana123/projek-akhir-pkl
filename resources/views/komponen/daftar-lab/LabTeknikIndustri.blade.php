...
<div id="subMenu7" class="hidden">
    <div class="bg-blue-400 text-white p-4 flex items-center justify-center relative">
        ...
        <h1 class="text-3xl font-bold mb-4 mt-10  text-center">Lab teknik industri</h1>
        ...
        <form action="{{ route('export.labTeknikIndustri') }}" method="GET" >
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-xs text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    @endforeach
                    <div class="mt-4 mb-5">
                        {{ $labIndustri->onEachSide(1)->links() }}
                    </div>
                </tbody>
            </table>
