...
<div id="subMenu3" class="hidden">
    <div class="bg-blue-400 text-white p-4 flex items-center justify-center relative">
        ...
        <h1 class="text-3xl font-bold mb-4 mt-10 text-center">Lab matematika</h1>
        ...
        <form action="{{ route('export.labMate') }}" method="GET" class="p-4">
    ...
    setTimeout(function() {
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-xs text-left rtl:text-right text-gray-500">
                ...
                <tbody>
                    @php
                        $no = ($labMate1->currentPage() - 1) * $labMate1->perPage() + 1
                    @endphp
