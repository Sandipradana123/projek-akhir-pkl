...
<div id="subMenu9" class="hidden">
    <div class="bg-blue-400 text-white p-4 flex items-center justify-center relative">
        ...
        <h1 class="text-3xl font-bold mb-4 mt-10 text-center">Lab prodi akutansi</h1>
...
<form action="{{ route('export.LabProdiAka') }}" method="GET" class="p-4">
