                ...
                @foreach ($admin as $dataAdmin)
                    <tr
                        ...
                        <td class="px-6 py-4 flex justify-center gap-2">
                            ...
                            <button data-modal-target="popup-modal-hapus{{ $dataAdmin->id }}" data-modal-toggle="popup-modal-hapus{{ $dataAdmin->id }}" type="button">
                                    ...
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500">
                                                Apakah kamu yakin untuk menghapus admin {{ $dataAdmin->username }}</h3>
